...
글조각 서랍의 제품, 배포, 기능 및 기술 문서를 찾기 위한 색인이다.

## App Store와 배포

- [App Review 제출 자료](APP_REVIEW_NOTES.md)
- [App Review 준비](APP_REVIEW_PREPARATION.md)
...
- [로컬 TTS](LOCAL_TTS.md)
- [OCR 자동 교정](LOCAL_OCR_AUTOCORRECTION.md)
- [자동 태그](AUTOMATIC_TAGGING.md)
- [커뮤니티](COMMUNITY.md)

## 설정과 운영

- [도서 메타데이터 API 키](BOOK_METADATA_API_KEYS.md)
- [LLM 인증 정보 정리](LLM_CREDENTIAL_CLEANUP.md)
- [개인정보처리방침](PRIVACY_POLICY.md)
- [제3자 고지](THIRD_PARTY_NOTICES.md)
- [웹사이트 UI](WEBSITE_UI.md)

## 기술과 연구

- [성능 아키텍처](PERFORMANCE_ARCHITECTURE.md)
- [타이포그래피](TYPOGRAPHY.md)
- [AIB Arena 학습 연구](AIB_ARENA_LEARNING_RESEARCH.md)
- [AIB 사용자 선호 데이터 정의](AIB_HUMAN_PREFERENCE_DATA_DEFINITION.md)
